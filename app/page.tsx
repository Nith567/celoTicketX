...
export default function Home() {
    ...
    async function creatingEvent() {
        if (address) {
            ...
            try {
                const cEUR = "0x765DE816845861e75A25fCA122bb6898B8B1282a"; // replace with actual cEUR address
                const tx = await createEvent(
                  "brazilHotel",
                  "ipfs://bafkreihv536dl4wjsrekyo3baclqyls75kozgc3jposl5x5yr3zyem5guq",
                  cEUR,
                  "30000000000000000",
                  "ipfs://bafkreiaijjzijufrqbsxbgtrssvtacjzkclrzsmbysd5zxd6qqdb4rzcye"
                );
                setTx(tx);
            } catch (error) {
                console.log(error);
